...
image = imreader('C:\Users\JCP\OneDrive\桌面\CV PROJECT\delivery_area_dslr_undistorted\delivery_area\images\dslr_images_undistorted');

% Read camera intrinsic parameters using camera.txt reader
% 使用camera.txt读取相机的内参
camInfo = cameraReader('C:\Users\JCP\OneDrive\桌面\CV PROJECT\delivery_area_dslr_undistorted\delivery_area\dslr_calibration_undistorted\cameras.txt');
